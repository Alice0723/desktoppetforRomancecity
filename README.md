...
[点击下载 放青松 (.exe)](https://github.com/Alice0723/desktoppetforRomancecity/releases/download/v2.0/FangqingsongPet.exe)
...
音乐模式会优先识别系统里的音频会话，并结合窗口标题判断当前播放内容。对网页播放场景，像 B 站、YouTube、网易云音乐网页版这类只要浏览器窗口标题里能暴露出歌曲名或视频名，桌宠就能识别出来。

如果网页标题本身没有曲目名，或者浏览器/网站没有把播放内容写进窗口标题，桌宠最多只能判断“正在播放”，不一定能拿到准确歌名。
